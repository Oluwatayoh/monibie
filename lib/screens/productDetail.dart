          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(whiteSelected ? "White" : "Black",
                    style: reviewDateextStyle),
              ],
            ),
            SizedBox(
              height: 20,
            ...
            Row(
              children: [
                ProductContainer(
                    ...
                    borderColor: whiteSelected
                        ? HexColor(cPurple)
                        : HexColor(cgreyMedium))
              ],
            )
          ],
        ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text("Select Colour, Size", style: sub2TitletextStyle),
                      Text("Select", style: redSubTitletextStyle),
                    ],
                  ),
                  SizedBox(
                    height: 30,
